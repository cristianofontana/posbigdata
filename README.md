#O exemplo a seguir foi executado em uma VM Cloudera, carregando arquivos .txt no Hadoop Distributed File System (HDFS). Usando linguagem python no Apache Spark.
